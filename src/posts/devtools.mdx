import { EstimatedTimeToRead } from "@/components/estimated-time-to-read";

export const metadata = {
  title: "On Developer Products",
  description: "What developers want from your product.",
...
# On Developer Products <EstimatedTimeToRead slug="devtools" />
...
## 6. You should have a great developer experience

Developer Experience (DX) is the sum of all the interactions a developer has with your product. It's the documentation, the support, the community, the product itself, and the developer tools.

If you have a great DX, developers will be more likely to use your product. If you have a poor DX, developers will be more likely to leave.

## 7. You should have a great developer experience
