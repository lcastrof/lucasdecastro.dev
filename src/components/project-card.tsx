  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        <header className="flex items-center justify-between text-gray-200 transition-colors group-hover:text-sky-500">
        ...
        {project.achievementsKeys && project.achievementsKeys.length > 0 && (
          <div className="space-y-3 pt-2">
            ...
            <ul className="list-disc pl-4 text-gray-400 space-y-2 marker:text-sky-500">
